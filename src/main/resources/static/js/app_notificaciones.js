const API_NOTIFICACIONES = "http://192.168.1.25:8080/api/v1/notificaciones";
...
async function mostrarNotificaciones() {
    try {
        ...
        const ordenesResp = await fetch("http://192.168.1.25:8080/api/v1/ordenes/listar");
        ...
        notificacionesDropdown.querySelectorAll('.dropdown-item').forEach(item => {
            item.addEventListener('click', async function(e) {
                ...
                await fetch(`http://192.168.1.25:8080/api/v1/notificaciones/marcar-leida/${notiId}`, {
                    method: 'PUT',
                    headers: { 'Content-Type': 'application/json' }
                });
